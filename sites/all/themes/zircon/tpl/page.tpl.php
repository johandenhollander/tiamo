<div id="page" class="page-default">
  ...
  <div id="header-wrapper" class="wrapper">
    <div class="container <?php print $grid; ?>">
      ...
      <div class="top-fixed-area"><?php if ($page['fixed_header']): ?>
  <div id="fixed-header">
...
<?php endif; ?></div><!-- /toevoeging -->
        <div id="header" class="clearfix">
		  ...
		  <div id="menu-bar-wrapper" class="wrapper">
		    <div class="container <?php print $grid; ?>">
			  <div class="grid-inner clearfix">
			    <a title="Navigation Icon" href="#mmenu_left" class="tb-main-menu-button responsive-menu-button"><img src="/sites/all/themes/zircon/images/menubutton.png" width="112px" height="56px"></a> </a>
			    <?php print $menu_bar; ?>
			  </div>
		    </div>
		  </div>
